...
void steering_report_cb(const dbw_mkz_msgs::SteeringReport::ConstPtr &msg)
{
    ...
    steering_wheel_angle_cmd = msg->steering_wheel_cmd;
    speed = msg->speed;
    is_steering_report_init = true;
    state(0) = 500045.034553; state(1) = 4982847.3993; state(2) = 0;
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle n;
    ros::Publisher pub_handle1 = n.advertise<geometry_msgs::Twist>("/pacifica1/cmd_vel", 1);
    ros::Subscriber sub_handle1 = n.subscribe("/pacifica1/steering_report", 1, steering_report_cb);
    ros::Subscriber sub_handle2 = n.subscribe("/target_path", 1, path_cb);
